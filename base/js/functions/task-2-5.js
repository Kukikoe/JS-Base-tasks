(function() {
	"use strict";
const number = document.getElementById("functions-task-2-input-number");
const btn = document.getElementById("functions-task-2-btn-find-out");
const result = document.getElementById("functions-task-2-result");
